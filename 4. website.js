// This is not a good way to do it. This is just to show how to use http server and how to use the request and response objects.
// This is why we use express.js
